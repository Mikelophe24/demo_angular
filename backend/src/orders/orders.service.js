...
var OrdersService = function () {
    ...
    var OrdersService = _classThis = /** @class */ (function () {
        function OrdersService_1(ordersRepository, productsService) {
        ...
        OrdersService_1.prototype.create = function (orderData) {
            return __awaiter(this, void 0, void 0, function () {
                var items, total, _i, _a, itemRequest, product, orderItem, order;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            itemRequest = _a[_i];
                            return [4 /*yield*/, this.productsService.findOne(itemRequest.productId)];
                        case 2:
                            product = _b.sent();
                            if (!product)
                                return [3 /*break*/, 3];
                        ...
                        case 4:
                            ...
                            order.items = items;
                            return [2 /*return*/, this.ordersRepository.save(order)];
                    }
                });
            });
        };
        OrdersService_1.prototype.updateStatus = function (id, status) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ordersRepository.update(id, { status: status })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.ordersRepository.findOne({
                                    where: { id: id },
                                    relations: ['items', 'items.product'],
                                })];
                    }
