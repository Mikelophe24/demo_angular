...
var ProductsController = function () {
    ...
    var ProductsController = _classThis = /** @class */ (function () {
        ...
        ProductsController_1.prototype.findAll = function (category, minPrice, maxPrice, sort) {
        ...
        ProductsController_1.prototype.create = function (product) {
            return this.productsService.create(product);
        };
        ProductsController_1.prototype.update = function (id, product) {
