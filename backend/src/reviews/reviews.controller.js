...
var ReviewsController = function () {
    ...
    var ReviewsController = _classThis = /** @class */ (function () {
        ...
        ReviewsController_1.prototype.create = function (createReviewDto) {
            return this.reviewsService.create(createReviewDto);
        };
        ReviewsController_1.prototype.findAll = function (id) {
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.Get)('product/:id')];
